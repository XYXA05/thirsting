    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 w-full h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-3xl text-center text-white">
          ...
          >
            Join millions of people who have already found their soulmate.
            The most reliable platform for serious relationships.
          </p>

          {/* CTA Button - Enhanced animations */}
          <button
            onClick={() => (window.location.href = "https://tone.affomelody.com/click?pid=123437&offer_id=319")}
